<?php
 ...
 define( 'DB_USER', 'jlooper_Imagine' ); // set database user
 define( 'DB_PASS', 'Robs100Poodles' ); // set database password
 define( 'DB_NAME', 'jlooper_ImagineSalon' ); // set database name
 define( 'SEND_ERRORS_TO', 'ssjvegitto@gmail.com' ); //set email notification email address
